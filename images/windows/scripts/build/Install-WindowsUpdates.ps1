...
function Install-WindowsUpdates {
    ...
    Get-WindowsUpdate -MicrosoftUpdate -NotKBArticleID "KB5040711" -OutVariable updates | Out-Host
    ...
    Get-WindowsUpdate -MicrosoftUpdate -NotKBArticleID "KB5040711" -AcceptAll -Install -IgnoreUserInput -IgnoreReboot | Out-Host
