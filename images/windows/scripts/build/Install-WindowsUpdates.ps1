...
function Install-WindowsUpdates {
    ...
    Get-WindowsUpdate -MicrosoftUpdate -NotKBArticleID @("KB5034439", "KB5040711", "KB5055523") -OutVariable updates | Out-Host
    ...
    Get-WindowsUpdate -MicrosoftUpdate -NotKBArticleID @("KB5034439", "KB5040711", "KB5055523") -AcceptAll -Install -IgnoreUserInput -IgnoreReboot | Out-Host
